...
- Couleur d'avertissement : `amber`
  - Utilisé pour les messages d'avertissement et les éléments d'attention mais aussi asigné aux élément lier au "retard" dans la gestion des présences
- Couleur d'erreur : `red`
  - Utilisé pour les messages d'erreur et les éléments négatifs mais aussi asigné aux élément lier à l'"absence" dans la gestion des présences
- Couleur d'information supplementaire : `blue`
  - Utilisé pour les messages d'information et les éléments informatifs mais aussi asigné aux élément lier à la "justification" dans la gestion des présences
